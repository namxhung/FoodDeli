    ...
    <v-list two-line>
      <v-list-item class="px-0">
        <v-list-item-avatar rounded class="ma-0">
          <!-- <v-icon :color="item.type == 'veg' ? 'blue' : 'red'" small> -->
            <v-icon color="#FF7878" small>
            fas fa-tags
          </v-icon>
        </v-list-item-avatar>
        <v-list-item-avatar
        ...
        <v-list-item-action>
          <v-btn color="red" icon v-if="counter == 0" @click="increment">
            <v-icon small>fas fa-plus-square</v-icon>
          </v-btn>

          <div v-else>
            <v-btn color="blue" icon @click="decrement">
              <v-icon small>
                fas fa-minus-square
              </v-icon>
            </v-btn>
            ...
            <v-btn color="red" icon @click="increment">
              <v-icon small>fas fa-plus-square</v-icon>
            </v-btn>
          </div>
        </v-list-item-action>
